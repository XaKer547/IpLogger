    ...
    public class LoggerCommandConfiguration(ILogService logService) : ICommandConfiguration
    {
        public RootCommand ConfigureRootCommand()
        {
            ...
            rootCommand.SetHandler(
                ...
                {
                    var logs = logService.GetLogs(fileLogValue.FullName);
                    ...
                    var filteredLogs = logService.FilterLogs(logs, filter);

                    logService.SaveLogs(filteredLogs, fileOutputValue.FullName);
                },
